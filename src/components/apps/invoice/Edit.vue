...
<template>
  <v-card elevation="10">
    <v-card-item>
      <h5 class="text-20 font-weight-semibold mb-7">Edit Invoice Details</h5>
      ...
      <v-form ref="formRef" v-model="valid" lazy-validation v-if="!loading && invoice">
        <div class="bg-hoverColor mt-6 pa-6 rounded-md">
          <v-row>
            <v-col cols="12" md="4">
              <v-label class=" pb-2">Bill From</v-label>
              <v-text-field
                hide-details
            ...
            <v-col cols="12" md="4">
              <v-label class=" pb-2">Bill To</v-label>
              <v-text-field
            ...
            <v-col cols="12" md="4">
              <v-label class=" pb-2">Status</v-label>
              <v-select
